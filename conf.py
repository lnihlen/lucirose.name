...
# Lucile Nihlen build configuration file, created by
# `ablog start` on Tue Jun 13 11:56:17 2023.
#
...
blog_title = "Lucile Nihlen"

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = "https://lucirose.name"
...
blog_authors = {
    "Luci": ("Lucile Nihlen", None),
}

blog_default_author = 'Luci'
...
project = "Lucile Nihlen"
copyright = "2023, Lucile Nihlen"
...
# documentation.
html_theme_options = {
    # Deliberately exclude "theme-switcher"
...
htmlhelp_basename = "LucileNihlendoc"
